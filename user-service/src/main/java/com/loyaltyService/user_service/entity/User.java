...
public class User implements Persistable<Long> {
    @Id private Long id;
    @Transient  // ADD THIS — tells JPA not to persist this field
    ...
    @Enumerated(EnumType.STRING) @Column(name = "role", nullable = false) @Builder.Default private Role role = Role.USER;
    ...
    @Builder.Default private List<KycDetail> kycDetails = new ArrayList<>();
    public boolean isActive()  { return this.status == UserStatus.ACTIVE && this.deletedAt == null; }
